//
//  WYLCompetitionInformationViewController.m
//  LLWTeamwork
//
...
#define kCell @"cell"
@interface WYLCompetitionInformationViewController ()
...
@implementation WYLCompetitionInformationViewController
- (void)dealloc
{
    self.dataSource = nil;
...
//    self.view.backgroundColor = [UIColor orangeColor];
    [self.tableView registerClass:[WYLInformationCell class] forCellReuseIdentifier:kCell];
...
- (void)readDataFromNetWork {
    ...
    NSString *urlString = [NSString stringWithFormat:kWYLCompetitionString, self.page];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    WYLInformationCell *cell = [tableView dequeueReusableCellWithIdentifier:kCell forIndexPath:indexPath];
