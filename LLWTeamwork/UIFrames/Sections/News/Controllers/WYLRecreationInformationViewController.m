//
//  WYLRecreationInformationViewController.m
//  LLWTeamwork
//
...
@interface WYLRecreationInformationViewController ()
...
@implementation WYLRecreationInformationViewController
- (void)dealloc
{
    self.dataSource = nil;
    [super dealloc];
...
- (void)readDataFromNetWork {
    ...
    NSString *urlString = [NSString stringWithFormat:kWYLRecreationString, self.page];
